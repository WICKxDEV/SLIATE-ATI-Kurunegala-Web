...
<html>
  ...
  <body>
    <section class="sub-header">
      ...
      <h1>Higher National Diploma in English</h1>
    </section>
      ...
      <div class="row">
        <div class="hnd-col">
          ...
          <p>
            ...
            Passed the G.C.E. (A/L) examination in one sitting in any stream
            (General English will not be considered as one of the main three
            subjects) And Ordinary pass for English and Mathematics at the
            G.C.E. (O/L) examination Or Ordinary pass for Appreciation of
            English Literary Text at the G.C.E. (O/L) examination<br /><br />

            <u>Part Time : 2 1/2 years</u><br />
            In addition to the above qualifications in Full Time, the applicant
            should be employed in the government sector / public enterprise /
            recognized firm (must produce particulars regarding EPF/ETF) or
            self-employed (entrepreneur). Should produce legal documents at the
            interview.
          </p>
        </div>
      </div>
      <div class="row">
        <div class="hnd-col">
          ...
          <p>
            ...
            Course fees for the part time students will be Twelve Thousand
            Rupees (Rs. 12000.00) per Semeste
          </p>
        </div>
      </div>
    </section>
